package com.tool.clinglibrary2.service.upnp;


import com.tool.clinglibrary2.database.MediaContentDao;
import com.tool.clinglibrary2.entity.VItem;
    ...
    static class ContainerFactory {
        static Container createContainer(String containerId) {
            ...
            if (VItem.ROOT_ID.equals(containerId)) {
                ...
                MediaContentDao contentDao = new MediaContentDao(VMTools.getContext());
                //Get audio items
