package com.tool.clinglibrary2.service;

import android.content.Intent;
import android.os.IBinder;

import com.tool.clinglibrary2.service.upnp.AndroidJettyServletContainer;
import com.tool.clinglibrary2.service.upnp.ClingContentDirectoryService;
...
public class ClingService extends AndroidUpnpServiceImpl {
    ...
    private void initLocalDevice() {
        ...
        VMLog.d(TAG, "MediaServer device created! name:%s, manufacturer:%s, model:%s",
